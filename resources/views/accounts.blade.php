                            ...
                            @if (!empty($orders))
                                @foreach ($orders as $order)
                                    <tr class="{{ $order->IsRead == 2 ? 'new' : '' }}">
                                        ...
                                        <td><img src="{{ asset('uploads/orders/digi/' . $order->File1) }}"
                                                width="50px"></td>
                                        <td><button type="button" class="btn btn-default btn-flat btn-sm"
                                                onclick="location.href='{{ url('') }}/digi_approval/{{ $order->OrderID }}'">Details</button>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
