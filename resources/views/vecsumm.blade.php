                    ...
                    <tbody>
                        @if(!empty($allrecords))
                            ...
                            <tr class="{{$order->IsRead == 2 ? 'new' : ''}}">
                                 ...
                                 <!--  <td><img src="{{ asset('uploads/orders/vector/'.$order->File1) }}" width="50px"></td>
                                  --> <td><button type="button" class="btn btn-default btn-flat btn-sm" onclick="location.href='{{ url('') }}/vector_approval/{{$order->VectorOrderID}}'">Details</button></td>
                                </tr>
                            @endforeach
                        @endif
                    </tbody>
