            ...
            <div class="content-wrapper">
                <div class="container">
                    ...
                    <section class="content-header">
                        <h1>Update Order Price Digitizing</h1>
                        <ol class="breadcrumb">
                    ...
                    <section class="content">
                        {!! Form::open([ 'url' => 'admin/digi_prices/'.$order_digi->OrderID, 'files' => true]) !!}
                        <div class="row">
                            <div class="col-md-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    {!! Form::text('OrderID', $order_digi->OrderID, ['class' => 'form-control', 'readonly' => 'true']) !!}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    {!! Form::text('DesignName', $order_digi->DesignName, ['placeholder' => 'Enter Design Name', 'class' => 'form-control', 'id' => 'CustomerName']) !!}
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="Cell">Quantity: </label>
                                                                     ...
                                                                     <input type="number" placeholder="Enter Quantity" value="{{$order_digi->Quantity}}" class="form-control" name="qty"  onchange="setPricebyQty(this);" id="qty"  required="true" >
                                                                </div>
                                                            </div>
                                                             <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="Cell">Unit Price:</label>
                                                                      ...
                                                                      <input type="text" placeholder="Enter Price" onchange="set_final(this);" id="price" class="form-control" value="{{$order_digi->PriceBeforeDiscount}}" name="OrderPrice" required="true" ?>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="Enter Discount" value="{{ $order_digi->Discount}}" id="disc" onchange="cal_price(this);" class="form-control" name="Discount" ><br>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="Cell">Order Full Price: </label>
                                                                      ...
                                                                      <input type="text" id="actfinalprice" value="{{$order_digi->Price}}" class="form-control" name="myText" <?php  if($order_digi->Price == ''){ ?> style="display:none" <?php } ?> disabled>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    PKR{!! Form::number('DesignerPrice', $order_digi->DesignerPrice, ['placeholder' => 'Enter Designer Price', 'class' => 'form-control', 'id' => 'Email']) !!}
                                                                </div>
                                                            </div>
                                                            <?php  if($order_digi->SalesPersonID > 0){ ?>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="Fax">Sales Commision: </label>
                                                                    PKR{!! Form::number('SalesComm', $order_digi->SalesPrice, ['placeholder' => 'Enter Sales Commission', 'class' => 'form-control']) !!}
                                                                </div>
                                                            </div>
