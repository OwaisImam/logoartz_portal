...
<head>
        ...
        <!-- Basic Page Needs
      ================================================== -->
        <title>{{ $configuration->WebsiteTitle }} | Digitizing Quote</title>
...
<body class="inner body-innerwrapper">
        ...
        <div class="container ">
            <div class="row">
                <div class="col-sm-12 text-center breadcrumb-block">
                    ...
                    <?php } ?>
                        <li class="active">Digitizing Quote</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <!--Services-->
                                 ...
                                 {{ Form::open(['method'=>'post', 'url'=>'/sbt_digi_quote', 'files'=>'true']) }}


    <div class="container" style="padding:2em;">
            <section>	
                 <h3 style="color:#555555;text-align: center;margin-top: 7px;">PLACE DIGITIZING QUOTE </h3> 
                 <form role="form">
                         ...
                         <div class="col-md-3"> 
                             ...
                             <div class="col-md-3"> 
                                 ...
                                 <div class="form-group">
                                         ...
                                         {{ Form::select('Placement', array('' => 'Select',
                                                                        'Cap' => 'Cap',
