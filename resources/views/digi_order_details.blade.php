...
<head>
        ...
        <!-- Basic Page Needs
      ================================================== -->
        <title>{{ $configuration->WebsiteTitle }} | Digitizing {{ $type }} Details</title>
        ...
        <div class="container ">
            <div class="row">
                <div class="col-sm-12 text-center breadcrumb-block">
                    ...
                    <?php } ?>
                        <li class="active">Digitizing {{ $type }}</li>
                    </ol>
                </div>
            </div>
        </div>
                   ...
                   <?php echo date('d-m-Y', strtotime($order->DateAdded)); ?>
                         ...
                         <div class="col-sm-8 service-inner padding-left" style="margin-top: 20px">
                           <div class="service-item">
                            <div class="row">
                                     <h4 style="margin-left: 15px">Your Artwork:</h4>
                                            ...
                                            foreach ($DesignFiles as $fls) {
                                                ?>
                                                 ...
                                                 @if($fls->Category == 'a')
                                                   ...
                                                   <?php } ?>
                                                    <a style="font-size: 12px; margin: 4px; padding: 4px" href="{{ asset('uploads').'/orders/digi/'.$fls->File }}" class="btn btn-success btn-flat" download><i class="fa fa-download"></i> {{ $fls->File }}</a> 
                                                <?php $counta++;  ?>
                        ...
                        <div class="col-sm-8 service-inner padding-left" style="margin-top: 20px">
                            <div class="service-item">
                                @if($order->Status == 0 || $order->Status == 1 || $order->Status == 2)
                                    <h4>Your {{ $type }} is under processing</h4>
                                @elseif($order->Status == 3 && $order->OrderType == 2 || $order->OrderType == 4)
                                   <h4>Convert to Order</h4>
                                    <p>
                                        <button type="button" class="btn btn-success btn-flat" onclick="location.href='{{url('digi_order_approve').'/'.$order->OrderID}}'">PROCEED</button>
                                    </p>
                                ...
                                @elseif($order->Status == 7 && $order->OrderType == 2 || $order->OrderType == 4)
                                    ...
                                    <p>
                                        <button type="button" class="btn btn-success btn-flat" onclick="location.href='{{url('digi_order_done').'/'.$order->OrderID}}'">Done</button> <br>
                            ...
                            <div class="service-item">
                                ...
                                <h4>Revise {{ $type }}:</h4>
                                 ...
                                 @include('admin/includes/front_alerts')
                                <div class="col-md-12"> 
                                    {!! Form::open([ 'url' => 'digi_revise/'.$order->OrderID, 'files'=>'true', 'id' => 'revise_submit']) !!}
                                    <div class="form-group">
                                        <label for="OtherFormat">Instruction:</label>
                                        {{ Form::textarea('AddIns', null, ['placeholder' => 'Instruction For Logo Artz Support Team', 'class' => 'form-control', 'row' => '5', 'requried']) }}
                                    </div>

                                       <div class="form-group">
                                             <label for="OtherFormat">Upload File:</label>
                                            ...
                                            <?php
                                              ...
                                              $countc = 0;
                                                    ...
                                                    <div class="col-md-12" style="margin-top: 5px">
                                                        <a href="{{asset('uploads/orders/digi').'/'.$mfile->File}}" class="btn btn-success btn-flat btn-sm" download="" id="btn-sm"><i class="fa fa-download"></i> {{ $mfile->File }}</a>
                                                    </div> <br>
                                                  <?php $counta++;  ?>
                                                 <div class="clearfix"></div>
                                               @endif
