            ...
            <div class="content-wrapper">
                <div class="container">
                    ...
                    <section class="content-header">
                        <h1><i class="fa fa-users"></i> Summary</h1>
                        <ol class="breadcrumb">
                        ...
                        <div class="row">
                             ...
                             <div class="col-md-3 col-sm-6 col-xs-12">
                                    <label for="RequriedClr">From:</label>
                                     {!! Form::date('DateFrom', null, ['class' => "form-control", 'placeholder' => "Select Date"]) !!}

                            </div>

                             <div class="col-md-3 col-sm-6 col-xs-12">
                                <label for="RequriedClr">TO:</label>
                                {!! Form::date('DateTo', null, ['class' => "form-control", 'placeholder' => "Select Date"]) !!}
...
<?php  
                   ...
                   ?>
                                              ...
                                              <tr class="newclass<?php echo $OrderData->Status ?>"> 
                                                  ...
                                                  <td>
                                                    <Button class="btn btn-primary" type="button"onclick="location.href='{{ url('/salesperson/digi_order_detail/'.$OrderData->OrderID) }}'"> Detail</Button>
                                                  </td> 
                   ...
                   ?>
                                              ...
                                              <tr class="newclass<?php echo $OrderData->Status ?>"> 
                                                  ...
                                                  <td>
                                                    <Button class="btn btn-primary" type="button"onclick="location.href='{{ url('/salesperson/vector_order_detail/'.$OrderData->VectorOrderID) }}'"> Detail</Button>
                                                  </td> 
