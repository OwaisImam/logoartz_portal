    ...
    <nav class="navbar navbar-static-top">
        <div class="container">
            ...
            <div class="navbar-header">
                <a href="{{ url('salesperson') }}" class="navbar-brand"><span class="logo-lg"><img class="img-responsive" src="{{ asset('assets/admin/') }}/images/header-logo.png" style="height: 49px;margin-top: 4px; margin: 0 auto;"></span></a>
