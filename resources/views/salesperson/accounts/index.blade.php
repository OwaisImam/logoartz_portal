                ...
                <div class="container">
                    ...
                    <section class="content-header">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Sales Accounts</li>
                        </ol>
                    </section>
                    <!-- Main content -->
                            ...
                            <div class="col-xs-12">
                                <div class="box box-success">
                                    ...
                                    <div class="box-body table-responsive">
                                     {!! Form::open(['url' => 'salesperson/accounts_summary']) !!}
                        ...
                        <div class="row">
                             ...
                             <div class="col-md-2 col-sm-6 col-xs-12">
                              ...
                              <div class="col-md-3 col-sm-6 col-xs-12">
                               ...
                               <?php   
                                 if(!empty($customers)){
                                        foreach ($customers as $allcutomers) {
                                   ?> 

                                <option class="form-control" value="{{ $allcutomers->CustomerID }}">{{ $allcutomers->CustomerName }} </option>
...
<?php  
                   ...
                   ?>
                                              ...
                                              <tr class="newclass<?php echo $OrderData->Status ?>"> 
                                                  ...
                                                  <td>{{ $OrderData->SalesPersonName }}</td>
                                                    <td ><strong class="label label-success" style="font-size: 15px">Rs. {{ $OrderData->SalesPrice }}</strong></td>
