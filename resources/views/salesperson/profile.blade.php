            ...
            <div class="content-wrapper">
                <div class="container">
                    ...
                    <section class="content">
                        {!! Form::open([ 'url' => 'salesperson/profile', 'files'=>true]) !!}
                        <div class="row">
                            <div class="col-md-12">
                                                ...
                                                <div class="box box-primary">
                                                    ...
                                                    <div class="box-body">
                                                        <div class="form-group">
                                                            ...
                                                            {!! Form::text('Name', $salesperson->SalesPersonName, ['class' => 'form-control', 'id' => 'FirstName']) !!}
                                                        </div>
                                                     
                                                        <div class="form-group">
                                                            <label for="Contact">Contact <span class="mandatory">*</span></label>
                                                            {!! Form::text('Cell', $salesperson->Cell, ['class' => 'form-control', 'id' => 'Contact']) !!}
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="Email">Email <span class="mandatory">*</span></label>
                                                            {!! Form::email('Email', $salesperson->Email, ['class' => 'form-control', 'id' => 'Email']) !!}
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="Username">Username <span class="mandatory">*</span></label>
                                                            {!! Form::text('Username', $salesperson->Username, ['class' => 'form-control', 'id' => 'Username']) !!}
                                                        </div>
                                                        <div class="form-group">
