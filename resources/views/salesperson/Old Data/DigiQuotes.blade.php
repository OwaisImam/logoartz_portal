                                            ...
                                            <tbody>
                                                @if(!empty($orders))
                                                    ...
                                                    <tr class="<?= $order->IsRead == 1 ? 'new' : '' ?>">
                                                        ...
                                                        <td><?= $order->Status == 5 ? '<label class="label label-warning">Approved Order to Complete</label>' : ($order->Status == 1 ? '<label class="label label-primary">New Order</label>' : ($order->Status == 6 || $order->Status == 7 ? '<label class="label label-info">Done</label>' : '<label class="label label-success">Quote Sent</label>')) ?></td>
