                    ...
                    <section class="content">
                        ...
                        <div class="box box-default">
                            <div class="box-header with-border">
                                <h3 class="" style="text-align: center;"><strong>{{ $heading }} Detail</strong></h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="box box-info">
                                    <div class="box-header">
                                        <h3 style="text-align: center;"><strong>Customer Art Work</strong></h3>
                                    </div>
                                    <div class="box-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    if ($VectorOrders->File1 != "") {
                                                        ?>
                                                        <a download="{{ $VectorOrders->File1 }}" href="{{ asset('uploads/orders/vector/'.$VectorOrders->File1) }}"><img src="{{ asset('uploads/orders/vector/'.$VectorOrders->File1) }}" width="300" /></a>
                                                        <?php
                                                    }
                                                    ?>   
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    if ($VectorOrders->File2 != "") {
                                                        ?>
                                                        <a download="{{ $VectorOrders->File2 }}" href="{{ asset('uploads/orders/vector/'.$VectorOrders->File2) }}"><img src="{{ asset('uploads/orders/vector/'.$VectorOrders->File2) }}" width="300" /></a>
                                                        <?php
                                                    }
                                                    ?>   
                                                </div>
