            ...
            <div class="content-wrapper">
                <div class="container">
                    ...
                    <section class="content-header">
                        <h1><i class="fa fa-users"></i> Vector Art  </h1>
                        <ol class="breadcrumb">
                            ...
                            <div class="col-xs-12">
                                <div class="box box-success">
                                    <div class="box-header with-border">
                                        <h3 class="box-title"><strong>VECTOR</strong></h3>
  ...
  <?php  
                   ...
                   ?>
                                                ...
                                                <tr class="newclass<?php echo $OrderData->Status ?>">
                                                  ...
                                                  <td>
                                                    <Button class="btn btn-primary" onclick="location.href='{{ url('/salesperson/vector_order_detail/'.$OrderData->VectorOrderID) }}'"> Detail</Button>
                                                  </td> 
                                                </tr>
