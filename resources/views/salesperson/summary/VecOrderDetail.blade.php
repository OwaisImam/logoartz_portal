                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                <button type="button" class="btn btn-sm btn-danger" data-toggle="modal"
                                    data-target="#modal-default">Delete Order
                                </button>
                            </div>
                        </div>
                        <!-- /.box-header -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <p>{{ $VectorOrders->Width . ' x ' . $VectorOrders->Height . ' ' . $VectorOrders->Scale }}
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <h5>{{ $VectorOrders->CustomerName }} </h5>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        @elseif($VectorOrders->Status == 6)
                                            ...
                                            foreach ($DesignFiles as $fls) {
                                                ?>
                                            <div class="col-md-6" style="margin-bottom:6px;">
                                                <input name="FileForCustomer[]" value="{{ $fls->VR_File_ID }}"
                                                    checked type="checkbox"> &nbsp; &nbsp; &nbsp;
                                                <a href="{{ asset('uploads/orders/vector') . '/' . $fls->File }}"
                                                    class="btn btn-success btn-flat" download=""><i
                                                        class="fa fa-download"></i> {{ $fls->File }}</a>
                                            </div>
                                            <?php
                                            }
                                            ?>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" placeholder="Enter Price"
                                                        class="form-control" name="OrderPrice"><br>
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" placeholder="Enter Price"
                                                        class="form-control" name="salesorp"><br>

                                                    <?php } ?>

                                                    <label>Enter Designer Price:</label>
                                                    <input type="number" placeholder="Enter Price"
                                                        class="form-control" name="designorp"><br>
                                ...
                                <div class="col-md-6">
                                    <div class="box box-primary">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <label>Current Designer:</label>
                                                <div><span class="text"> {{ $VectorOrders->DesignerName }}</span>
                                                </div>
                                            </div>
