...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Designers</title>
            ...
            <div class="content-wrapper">
                <div class="container">
                    ...
                    <section class="content-header">
                        <h1><i class="fa fa-users"></i> Designers</h1>
                        <ol class="breadcrumb">
                    ...
                    <!-- Main content -->
                    {!! Form::open([ 'url' => 'admin/designers/delete', 'id' => 'frm_list' ]) !!}
                    <section class="content">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box box-success">
                                    <div class="box-header with-border">
                                        <h3 class="box-title">Designers</h3>
