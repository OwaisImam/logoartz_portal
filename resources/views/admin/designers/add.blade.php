...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Add New Designer</title>
                ...
                <div class="container">
                    ...
                    <section class="content-header">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><a href="{{ url('admin/designers') }}">Designer</a></li>
                    ...
                    <section class="content">
                        {!! Form::open([ 'url' => 'admin/designers/add', 'files' => true]) !!}
                        <div class="row">
                            <div class="col-md-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="DesignerName">Designer Name: <span class="mandatory">*</span></label>
                                                                    {!! Form::text('DesignerName', null, ['placeholder' => 'Enter Customer Name', 'class' => 'form-control', 'id' => 'CustomerName']) !!}
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    {!! Form::select('Category',  array('1' => 'Vector Artist', '2' => 'Digitizer'), '1', ['class' => 'form-control', 'id' => 'Category']) !!}
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
