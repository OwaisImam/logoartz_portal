        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="container">
                    ...
                    <!-- Main content -->
                    {!! Form::open([ 'url' => 'admin/customers/delete', 'id' => 'frm_list' ]) !!}
                                ...
                                <div class="box box-success">
                                    <div class="box-header with-border">
                                        ...
                                        <div class="box-tools pull-right">
                                            <button type="button" class="btn btn-sm btn-primary" onClick="location.href = '{{ url('admin/customers/add') }}'"><i class="fa fa-plus"></i>Add New</button>
