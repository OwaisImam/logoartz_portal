...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Sales Person</title>
            ...
            <div class="content-wrapper">
                <div class="container">
                    ...
                    <section class="content-header">
                        <h1><i class="fa fa-users"></i>Sales Person</h1>
                        <ol class="breadcrumb">
                    ...
                    <!-- Main content -->
                    {!! Form::open([ 'url' => 'admin/salesperson/delete', 'id' => 'frm_list' ]) !!}
                                ...
                                <div class="box box-success">
                                    <div class="box-header with-border">
                                        ...
                                        <div class="box-tools pull-right">
                                            <button type="button" class="btn btn-sm btn-primary" onClick="location.href = '{{ url('admin/salesperson/add') }}'"><i class="fa fa-plus"></i> Add New</button>
        ...
        <script language="javascript">
                                                ...
                                                function doDelete()
                                                {
                                                    if (checkboxes.filter(':checked').length > 0)
                                                    {
                                                        ...
                                                        message_box("Confirm", "This will delete all Sales Person.<br>Are you sure?", "confirm", ok, null);
                                                    } else
                                                    {
                                                        message_box("Alert", "Please select Sales Person to delete", "alert", null, null);
                                                    }
                                                }
        </script>
    </body>
