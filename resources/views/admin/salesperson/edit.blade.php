            ...
            <div class="content-wrapper">
                <div class="container">
                    ...
                    <section class="content">
                        {!! Form::open([ 'url' => 'admin/salesperson/'.$design->SalesPersonID, 'files' => true]) !!}
                        <div class="row">
                            <div class="col-md-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    {!! Form::text('SalesPersonName', $design->SalesPersonName, ['placeholder' => 'Enter Customer Name', 'class' => 'form-control', 'id' => 'CustomerName']) !!}
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
