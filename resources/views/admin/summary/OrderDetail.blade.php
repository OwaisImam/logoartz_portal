    ...
    <body class="hold-transition skin-blue layout-top-nav">
        ...
        {!! Form::open([ 'url' => 'admin/order/ddelete', 'id' => 'frm_list' ]) !!}
          ...
          <h3 class="" style="text-align: center;">Digitizing {{ $type }} Detail</h3>
             ...
             <button type="button" class="btn btn-sm btn-default" onclick="location.href='{{ url('/admin/edit-order/'.$DigiOrders->OrderID) }}'" >Edit {{ $type }}
              </button>  

             <!--    <button type="button" class="btn btn-sm btn-default" value="Print" 
               onclick="window.print()" >Print {{ $type }}
              </button>   -->
              ...
              <table class="table table-bordered">
                ...
                <tr>
                 ...
                 <tr>
                  ...
                  <td><label>Upload On</label> </td>
                  <td>
                    

                   <?php echo date('d-m-Y', strtotime($DigiOrders->DateAdded)); ?>
                  </td>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3"> 
                                                <div class="form-group">
                                                    ...
                                                    <div><span class="text text-sm"><h4>{{ $DigiOrders->DesignerName }}</h4></span></div>
                                            ...
                                            <tr class=""> 
                                              ...
                                              <td> {{ $revise['CustomerMessage'] }}</td>
                                                <td>
                                                   ...
                                                   <a href="{{asset('uploads/orders/digi_revision_customer').'/'.$rev_file->file}}" style="padding: 3px; margin: 3px" class="btn btn-success btn-flat" download=""><i class="fa fa-download"></i> {{ $rev_file->file }}</a>
                                        ...
                                        <div class="col-md-12">
                                         ...
                                         <?php
                                            ...
                                            <div class="col-md-5">
                                                 ...
                                                 <label>Price $</label>
                                                <input type="number" placeholder="Enter Quote" class="form-control" name="CustomerPrice"><br>
                                                <label>Timeline</label>
                                                <input type="text" placeholder="Enter Timeline" class="form-control" name="Timeline"><br>
                    
                                                <button class="btn btn-info btn-block" type="submit">Send Quote to Customer</button>
                                                {!! Form::close() !!}
                                            </div>
                                            @elseif($DigiOrders->Status == 6)
                                            {!! Form::open(['url' => 'admin/digi-send-order/'.$DigiOrders->OrderID,  'files'=>'true', 'id' => 'sndorder']) !!}
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                      ...
                                                      <?php
                                                       ...
                                                       if($DigiOrders->OrderType != 1 && $DigiOrders->OrderType != 4 && $DigiOrders->OrderType != 9){
                                                        ...
                                                        <input type="number" placeholder="Enter Quantity" value="{{$qtyfordefault}}" class="form-control" name="qty"  oninput="setPricebyQty(this);" id="qty"  <?php if($DigiOrders->OrderType != 1 && $DigiOrders->OrderType != 9){ echo "required"; } ?> >
                                                         </div>  
                                                    </div><br>
                                                    ...
                                                    <div class="row">
                                                         <div class="col-md-5">
                                                       <label>Price $</label>
                                                       <input type="text" placeholder="Enter Price" oninput="set_final(this);" id="price" class="form-control" name="OrderPrice" <?php if($DigiOrders->OrderType == 0){ echo "required"; } ?>  ><br>
                                                    ...
                                                    <input type="text" placeholder="Enter Discount" id="disc" oninput="cal_price(this);" class="form-control" name="Discount" ><br>
                                             ...
                                             <h4 class="box-title" style="text-align: "><strong>Staff Account:</strong></h4>
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                    <div class="col-md-5">
                                                    <input type="text" placeholder="Enter Price" class="form-control" name="salesorp"> </div>
                                                    </div>
                                                ...
                                                <br>
                                                    ...
                                                    <div class="row"> 
                                                    <div class="col-md-5">
                                                    <input type="text" placeholder="Enter Price" class="form-control" name="designorp"></div></div><br>
