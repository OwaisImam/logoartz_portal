...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Sales Summary</title>
                            ...
                            <div class="col-xs-12">
                                <div class="box box-success">
                                    <div class="box-header with-border">
                                        <h3 class="box-title"><strong>ORDERS AND QUOTES RECORD</strong></h3>
                                    </div>
              <div class="alert alert-info alert-dismissible">
                ...
                Orders Select Between From or TO Date.
                                    ...
                                    <div class="box-body table-responsive">
                                     {!! Form::open(['url' => 'admin/search/summary/salesrep']) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                 ...
                                 <label for="Salestm">Sales Reps:</label>
