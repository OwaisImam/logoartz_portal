...
.th{
  border-color: #fff; border-style: solid; border-width: 2px; text-align: center;
}
                ...
                <div class="row" style="margin-top: 40px">
                    <div class="col-xs-12 table-responsive">
                        <table class="table table-striped auto-index">
                            <thead>
                                <tr style="border-color: #0000; border-style: solid; border-width: 10px; background-color: #bdbec0; color: white">
                                    <th class="th">S.No</th>
                            ...
                            <tbody >
                                ...
                                if (!empty($DigiOrders)) {
                                    ...
                                    foreach ($DigiOrders as $digi) {
                                        ...
                                        <tr>
                                            <td></td>
                                            <td  class="td"><input type="number" class="form-control" name="digi_orId[]" value="{{ $digi->OrderID }}"></td>
                                            <td class="td"><input type="text" class="form-control" name="digi_orName[]" value="{{ $digi->DesignName }}"></td>
                                            <td class="td">Digitizing</td>
                                            <td class="td"><input type="text" class="form-control" name="digi_orDate[]" value="<?php echo date('j M Y', strtotime($digi->DateAdded)); ?>"> </td>
                                            <td class="td"><input type="text" class="form-control" name="digi_orQty[]" value="{{ $digi->Quantity }}"> </td>
                                            <td class="td"><input type="text" class="form-control" name="digi_prUnit[]" value="{{ $digi->PriceBeforeDiscount }}"> </td>
                                            <td class="td"><input type="number" class="form-control" name="digi_orDiscount[]" value="{{ $digi->Discount }}"></td>
                                            <td class="td"><input type="text" name="digi_orPrice[]" class="form-control" value="{{ $digi->Price }}">  </td>
                                ...
                                if (!empty($VecOrders)) {
                                    ...
                                    foreach ($VecOrders as $vector) {
                                        ...
                                        <tr>
                                            <td></td>
                                            <td class="td"><input type="number" class="form-control" name="vec_orId[]" value="{{ $vector->VectorOrderID }}"></td>
                                            <td class="td"><input type="text" class="form-control" name="vec_orName[]" value="{{ $vector->DesignName }}"></td>
                                            <td class="td">Vector</td>
                                            <td class="td"><input type="text" class="form-control" name="vec_orDate[]" value="<?php echo date('j M Y', strtotime($vector->DateAdded)); ?>"></td>
                                            <td class="td"><input type="text" class="form-control" name="vec_orQty[]" value="{{ $vector->Quantity }}"> </td>
                                            <td class="td"><input type="text" class="form-control" name="vec_prUnit[]" value="{{ $vector->PriceBeforeDiscount }}"> </td>
                                            <td class="td"><input type="number" class="form-control" name="vec_orDiscount[]" value="{{ $vector->Discount }}"> </td>
                                            <td class="td"><input type="number" class="form-control" name="vec_orPrice[]" value="{{ $vector->Price }}"> </td>
