...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Designer Accounts</title>
            ...
            <div class="content-wrapper">
                <div class="container">
                    ...
                    <section class="content-header">
                        <h1><i class="fa fa-users"></i>Designers Accounts Summary</h1>
                        <ol class="breadcrumb">
                            ...
                            <div class="col-xs-12">
                                <div class="box box-success">
                                    <div class="box-header with-border">
                                        <h3 class="box-title"><strong>Designers Summary</strong></h3>
                                    </div>
                   <!--   <div class="row">
                                    ...
                                    <div class="box-body table-responsive" >
                                     {!! Form::open(['url' => 'admin/search/designerac']) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                ...
                                <label for="Cetagory">Designers:</label>
                                 <select name="desname" class="form-control" required>
                               ...
                               <?php   
                                ...
                                <option class="form-control" value="{{ $design->DesignerID }}">{{ $design->DesignerName }} </option>
...
<?php  
                   ...
                   ?>
                                              ...
                                              <tr class="newclass<?php echo $OrderData->Status ?>"> 
                                                  ...
                                                  <td ><strong class="label label-danger" style="font-size: 15px">Rs. {{$OrderData->DesignerPrice}}</strong></td>
                   ...
                   ?>
                                              ...
                                              <tr class="newclass<?php echo $OrderData->Status ?>"> 
                                               ...
                                               <!--    <td><input type="checkbox" id="checkAllNone" class="all" /></td> -->
                                                  ...
                                                  <td>{{ $OrderData->DesignerName }}</td>
                                                  <td>{{ $OrderData->DateAdded }}</td>
                                                   <td ><strong class="label label-danger" style="font-size: 15px">Rs. {{$OrderData->DesignerPrice}}</td>
                                             <!-- 
