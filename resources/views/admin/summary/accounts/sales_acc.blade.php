...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Sales Accounts</title>
                            ...
                            <div class="col-xs-12">
                                <div class="box box-success">
                                    <!-- <div class="box-header with-border">
                                        <h3 class="box-title"><strong>Accounts Summray</strong></h3>
                                    </div> -->
                     <div class="row">
...
<?php  
                   ...
                   ?>
                                              ...
                                              <tr class="newclass<?php echo $OrderData->Status ?>"> 
                                                  ...
                                                  <td ><strong class="label label-danger" style="font-size: 15px">Rs. {{$OrderData->SalesPrice}}</strong></td>
...
<?php  
                   ...
                   ?>
                                              ...
                                              <tr class="newclass<?php echo $OrderData->Status ?>"> 
                                                  ...
                                                  <td>Vector</td>
                                                  <td>{{ $OrderData->DateAdded }}</td>
                                                   <td ><strong class="label label-danger" style="font-size: 15px">Rs. {{$OrderData->SalesPrice}}</td>
