...
<html lang="en" class="demo-2 no-js">
    <head>
     ...
     <body class="inner body-innerwrapper" style="font-size: 22px">
        ...
        <section id="breadcrumb" class="two green-color">
            <div class="container ">
                ...
                <div class="row">
                    <div class="col-md-4">
                         <img src="{{ public_path('') }}/logo.png')}}" width="200" height="100">
                    </div>
            ...
            <section class="invoice">
                ...
                <div class="row" style="margin-top: 20px">
                    ...
                    <div class="col-xs-6">
                        ...
                        <img src="{{ public_path('') }}/credit/american-express.png" alt="American Express">
