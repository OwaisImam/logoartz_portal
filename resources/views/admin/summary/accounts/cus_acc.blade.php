...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Customer Accounts</title>
            ...
            <div class="content-wrapper">
                <div class="container">
                    ...
                    <section class="content-header">
                        <h1><i class="fa fa-users"></i>Customers Accounts Summary</h1>
                        <ol class="breadcrumb">
            ...
            <div class="row">
                           ...
                           @include('admin/includes/front_alerts')                  
                                    ...
                                    <div class="box-body table-responsive" >
                                     {!! Form::open(['url' => 'admin/search/cus']) !!}
...
{!! Form::open(['url' => 'admin/generate-cus-invoice', 'id' => 'invoice-form']) !!}
<div class="row">
                                    <div class="col-md-2 col-sm-6 col-xs-12 pull-right">
                                       <button type="button" class="btn bg-maroon btn-flat margin pull-left invoice-btn">Generate Invoice</button>
                                  </div>
                    </div>
...
<?php  
                   ...
                   ?>
                                              ...
                                              <tr class="newclass<?php echo $OrderData->Status ?>"> 
                                                  ...
                                                  <td><input type="checkbox" name="DOrderIDs[]" value="{{ $OrderData->OrderID }}" id="checkAllNone" class="all orderids" /></td>
...
<?php  
                   ...
                   ?>
                                              ...
                                              <tr class="newclass<?php echo $OrderData->Status ?>"> 
                                                  ...
                                                  <td><input type="checkbox" name="VOrderIDs[]" value="{{ $OrderData->VectorOrderID }}" id="checkAllNone" class="all orderids" /></td>
