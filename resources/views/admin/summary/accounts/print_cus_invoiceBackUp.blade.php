                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mx-auto">
                        <div class="col-sm-10 text-center breadcrumb-block pull-right"  style="margin-left: 130px">
                            <ol class="breadcrumb"  style="background-color:#bdbec0; height: 90px; width: 300px; border-bottom:#ED1C24; border-bottom-style: solid; border-color: #e6e4e4; border-width: 15px">
...
<!--                <div class="pull-right" style="width: 400; height: 200; background-color: gray">
         ...
         <div class="row invoice-info">
            ...
            <section class="invoice" style="margin-top: 0px">
                ...
                <!-- Table row -->
                <div class="row" style="margin-top: 2%; font-size: 16px">
                ...
                <div class="row" style="margin-top: 20px;">
                    ...
                    <div class="col-xs-7">
                        ...
                        <p class="text-muted well well-sm no-shadow" style="margin-top: 10px; color: red; font-size: 12px;">
                    ...
                    <div class="col-xs-3 pull-right">
                            <table class="table table-striped auto-index pull-right" style="font-size: 18px; margin-left: 0px"">
                                <tr style="background-color: #bdbec0;">
                                    <th style="width:50%">Subtotal:</th>
                                    <td><span style=" color: red;"> ${{ $Sub_Total }}</span></td>
                                </tr>
                            ...
                            ?>
                                <tr>
                                    <th >Discount:</th>
                                    <td>
                                        <span style="font-size: 18px; color: red;"> ${{ $Discount }}</span>
                                    </td>
                                </tr>
                                ...
                                <tr style="background-color: #bdbec0;">
                                    <th>Total:</th>
                                    <td style="font-size: 20px; color: red;">${{ $TotalPrice }} </span></td> 
                                </tr>
                            </table>
           ...
           <footer class="row" style="padding-bottom: 0px; margin-bottom: 0px; background-color:#BFBFBF; border-top: 10px; border-color:#D9D9D9; border-style: solid;">
