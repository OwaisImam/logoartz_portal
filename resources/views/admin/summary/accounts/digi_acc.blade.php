            ...
            <div class="content-wrapper">
                <div class="container">
                    ...
                    <section class="content-header">
                        <h1><i class="fa fa-users"></i>Digitizing Accounts Summary</h1>
                        <ol class="breadcrumb">
            ...
            <div class="row">
                            <div class="col-xs-12">
                                <div class="box box-success">
                                    <div class="box-header with-border">
                                        <h3 class="box-title"><strong>Digitizing Summary</strong></h3>
                                    </div>
                           ...
                           @include('admin/includes/front_alerts')                  
                                    ...
                                    <div class="box-body table-responsive" >
                                     {!! Form::open(['url' => 'admin/search/dacc']) !!}
...
{!! Form::open(['url' => 'admin/generate-digi-invoice', 'id' => 'invoice-form']) !!}
<div class="row">
...
<?php  
                   ...
                   ?>
                                              ...
                                              <tr class="newclass<?php echo $OrderData->Status ?>"> 
                                                  ...
                                                  <td><input type="checkbox" name="OrderIDs[]" value="{{ $OrderData->OrderID }}" id="checkAllNone" class="all orderids" /></td>
