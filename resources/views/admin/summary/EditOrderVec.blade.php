        ...
        <div class="content-wrapper">
            <div class="container">
                ...
                <section class="content">
                    {!! Form::open([ 'url' => 'admin/update-order-vector/', 'files' => true]) !!}
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    ...
                                    <div class="box-tools pull-right">
                                        ...
                                        <button type="button" class="btn btn-sm btn-warning" onclick="location.href = '{{ url('admin/Vec_order-details/'.$order->VectorOrderID) }}'"><i class="fa fa-times"></i> Cancel</button>
                                    </div>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                {!! Form::text('OrderNumber', $order->VectorOrderID, ['placeholder' => 'Order Number', 'class' => 'form-control' , 'disabled' , 'id' => 'OrderID']) !!}
                                                                <input type="hidden" name="id" value="{{ $order->VectorOrderID }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            {{ Form::select('ReqFormat', array('' => 'Select',
                                                                                    ...
                                                                                    'Other' => 'Other'), $order->ReqFormat, array('class' => 'form-control')) }}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            {{ Form::select('UsedFor', array('' => 'Select',
                                                                            ...
                                                                            'Other' => 'Other'),
                                          $order->UsedFor, array('class' => 'form-control')) }}
                                                        </div>
                                                    </div>

                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                        <label for="NumofClr">Requried Color:</label>
                                                             {{ Form::text('RequriedClr', $order->ReqColor, ['placeholder' => 'REQUIRED COLOR', 'class' => 'form-control']) }}
                                                     ...
                                                     <div class="col-md-3">
                                                        <div class="form-group">
                                                          ...
                                                          {{ Form::select('ReqSep', array(                     '' => 'Select',
                                                                                        'Yes' => 'Yes',
                                                                                        'No' => 'No'),
                                                         $order->ReqSeparation, array('class' => 'form-control')) }}
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    ?>  
                                                         ...
                                                         <a href="{{asset('uploads/orders/vector').'/'. $order->File1 }}" class="btn btn-success btn-flat" download=""><i class="fa fa-download"></i> {{  $order->File1 }}</a>
...
<!--                                                        <label >
                                                          <input type="checkbox" class="flat-red">
                                                            Do u Like to Remove this Artwork?
                                                        </label> -->
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    ?>  
                                                         ...
                                                         <a href="{{asset('uploads/orders/vector').'/'. $order->File2 }}" class="btn btn-success btn-flat" download=""><i class="fa fa-download"></i> {{  $order->File2 }}</a>
                                             ...
                                             <?php } ?>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    ?>  
                                                         ...
                                                         <a href="{{asset('uploads/orders/vector').'/'. $order->File3 }}" class="btn btn-success btn-flat" download=""><i class="fa fa-download"></i> {{  $order->File3 }}</a>
                                             ...
                                             <?php } ?>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    ?>  
                                                         ...
                                                         <a href="{{asset('uploads/orders/vector').'/'. $order->File4 }}" class="btn btn-success btn-flat" download=""><i class="fa fa-download"></i> {{  $order->File4 }}</a>
