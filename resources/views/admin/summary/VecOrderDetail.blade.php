            ...
            <div class="container">
               <section class="content">
                  ...
                  <div class="row"  style="font-size: 18px">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group">
                                       ...
                                       <div><span class="text text-sm"><h4> {{ $VectorOrders->DesignerName }}</h4></span></div>
                                    </div>
                                 </div>
                              </div>
                              <!-- /.form group
                                   ...
                                   @if($firstDesignerResponse != '')
                                              <div class="col-md-12"> 
                                                  <div class="form-group">
                                                      ...
                                                      <div style="color: red; font-size: 20px">{{ $firstDesignerResponse }}</div>
                                                  </div>              
                                              </div>
                                            @endif
                           ...
                           @if(!empty($Revision))
                                ...
                                <div class="box box-success">
                                    <div class="box-header with-border" style="text-align: center;">
                                        <h3 class="box-title" ><strong>Client Revision Instructions</strong></h3>
                                  ...
                                  <thead>
                                     ...
                                     @foreach($Revision as $revise)
                                            ...
                                            <tr class=""> 
                                              ...
                                              <td> {{ $revise['CustomerMessage'] }}</td>
                                                <td>
                                                   ...
                                                   <a href="{{asset('uploads/orders/vector_revision_customer').'/'.$rev_file->file}}" style="padding: 3px; margin: 3px" class="btn btn-success btn-flat" download=""><i class="fa fa-download"></i> {{ $rev_file->file }}</a>
                                          ...
                                          @endif
                                                  ...
                                                  <td>{{date('d-m-Y h:i', strtotime($revise['DateAdded']))}}</td>
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <div class="col-md-6" style="margin-bottom:6px;">
                                          ...
                                          <a href="{{asset('uploads/orders/vector').'/'.$fls->File}}" class="btn btn-success btn-flat" do wnload=""><i class="fa fa-download"></i> {{ $fls->File }}</a>
                                       </div>
                                       <?php $counta++;  ?>
                                 ...
                                 <div class="col-md-12">
                                    ...
                                    <input type="number" placeholder="Enter Quote" class="form-control" name="CustomerPrice">
                                    <br>
                                    <label>Enter Timeline</label>
                                    <input type="text" placeholder="Enter Timeline" class="form-control" name="Timeline">
                                    <br>
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <div class="row">
                                          <div class="col-md-5">
                                             <input type="text" id="actfinalprice" class="form-control" name="myText" style="display:none" disabled>
                                 ...
                                 <div class="col-md-5">
                                    <button class="btn btn-primary btn-block" id="releaseSubmit" type="submit">Release Order</button>
                                 </div>
                                 {!! Form::close() !!} @endif
                              </div>
                           </div>
                        ...
                        <div class="box box-primary">
                           ...
                           <div class="box-body m-l-250">
                              ...
                              <div class="form-group" style="margin-bottom: 20px">
                                 ...
                                 <p>
                                    <?= $history['DesignerMessage'] ?><small class="pull-right">{{ $history['DateAdded'] }}</small>
                                    <br>
                        ...
                        <div class="box box-primary">
                           ...
                           <div class="box-body m-l-250">
                              ...
                              <div class="form-group">
                                 ...
                                 <p>
                                    <?= $history->Message ?><small class="pull-right">{{$history->DateAdded}}</small>
                                 </p>
                              </div>
                              @endforeach
                           </div>
                     ...
                     @endif
                     <!-- /.col (left) -->
                     @if($VectorOrders->OrderType == 0 || $VectorOrders->OrderType == 2 || $VectorOrders->OrderType == 3) @if($VectorOrders->Status != 8) @if($VectorOrders->Status != 7) @if($VectorOrders->Status != 4) @if($VectorOrders->Status != 6) {!! Form::open(['url' => 'admin/vec-assign-designer/'.$VectorOrders->VectorOrderID]) !!}
                     <div class="col-md-6">
                        <div class="box box-primary">
                           <div class="box-header">
                     ...
                     {!! Form::close() !!} @else {!! Form::open(['url' => 'admin/order_revision/'.$VectorOrders->VectorOrderID]) !!}
                     <div class="col-md-6">
                        <div class="box box-primary">
                           <div class="box-header">
                     ...
                     {!! Form::close() !!} @endif @else @if(!empty($VectorOrders->DesignerID))
                     <div class="col-md-6">
                        <div class="box box-primary">
                           <div class="box-header">
                              <h3 class="box-title">Assigment </h3>
                     ...
                     @else {!! Form::open(['url' => 'admin/vec-assign-designer/'.$VectorOrders->VectorOrderID]) !!}
                     <div class="col-md-6">
                        <div class="box box-primary">
                           <div class="box-header">
                              <h3 class="box-title">Assigment </h3>
                     ...
                     @endif @elseif($VectorOrders->OrderType == 1 && $VectorOrders->Status != 6 && $VectorOrders->Status != 10 && $VectorOrders->Status != 7)
                     <div class="col-md-6">
                        <div class="box box-primary">
                           <div class="box-header">
                              <h3 class="box-title">Status </h3>
                     ...
                     @elseif($VectorOrders->Status == 10) @if($VectorOrders->OrderType == 1 || $VectorOrders->OrderType == 9) {!! Form::open(['url' => 'admin/order_revision/'.$VectorOrders->VectorOrderID]) !!}
                     <div class="col-md-6">
                        <div class="box box-primary">
                           <div class="box-header">
                              <h3 class="box-title">Revise {{ $type }} </h3>
                     ...
                     {!! Form::close() !!} @elseif($VectorOrders->OrderType == 4) {!! Form::open(['url' => 'admin/vec-assign-designer-rev/'.$VectorOrders->VectorOrderID]) !!}
                     <div class="col-md-6">
                        <div class="box box-primary">
                           <div class="box-header">
