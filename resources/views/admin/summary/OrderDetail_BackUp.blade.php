...
<!--         OLD WORK DIRECT ASSIGN TO EXITS DESIGNER
 ...
 -->
                     ...
                     @if($DigiOrders->OrderType == 4 &&  $DigiOrders->Status != 11)
                            ...
                            @if($DigiOrders->OrderType == 2 || $DigiOrders->OrderType == 4 && $DigiOrders->Status == 6)
                              {!! Form::open(['url' => 'admin/digi_order_revision/'.$DigiOrders->OrderID]) !!}
                            <div class="col-md-6">
                                <div class="box box-primary">
                                    <div class="box-header">
...
var myChart = new Chart(ctx, {
    ...
    options: {
      ...
      <?php if($DigiOrders->OrderType == 2 || $DigiOrders->OrderType == 4 &&  $DigiOrders->DesignerID != ""){  ?>
