...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Digi Orders</title>
   ...
   <div class="row">
                            <div class="col-xs-12">
                             ...
                             $order->Status == 5 ? '<label class="label label-warning">Approved Order to Complete</label>'


                             : ($order->Status == 1 ? '<label class="label label-primary">New Quote</label>'
                            
                             : ($order->Status == 10 ? '<label class="label label-warning">Quote Revision</label>'

                             : ($order->Status == 6 || $order->Status == 7 ? '<label class="label label-info">Done</label>' 
                             

                             : '<label class="label label-success">Quote Sent</label>'))) 
        ...
        <script language="javascript">
            ...
            $('#switch').change(function() {
                location.href='{{url("designer/digi")}}/'+$('#status').val();
              });
