...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Orders</title>
                            ...
                            <div class="col-xs-12">
                                <div class="box box-success">
                                    <div class="box-header with-border">
                                        <h3 class="box-title"><strong>SEARCH RESULT</strong></h3>
  ...
  <?php  
                   if(count($SearchResult) > 0) {
                      foreach ($SearchResult as $OrderData) {
                   ?>
                                     ...
                                     <tr> 
                                                  ...
                                                  <td>{{ $OrderData['OrderRef'] }}</td>
                                                  <td>{{ $OrderData['DesignerName'] }}</td>
                                                  
                                                  <td>
                                                    <Button class="btn btn-primary" onclick="location.href='{{ $OrderData['OrderDetailLink'] }}'"> Detail</Button>
                                                  </td> 
            ...
            <!-- /.content-wrapper -->
            @include('designer/includes/footer')
