                            ...
                            <div class="col-xs-12">
                                <div class="box box-success">
                                    <div class="box-header with-border">
                                        <h3 class="box-title"><strong>TODAYS DIGITIZING REVISION ORDERS</strong></h3>
                                     </div>
...
<tr>         
                                                  ...
                                                  <td>New Order</td>
                                                  <td><select class="form-control" name="Scale">
                                                 <option value="Inch">Noman</option>
                                                 <option value="Centimeter">Taha</option>
                                                 <option value="Millimeter">Ali</option>
                                                 <option value="Pixel">Imran</option>
                                                 </select></td>
                                                ...
                                                <tr>         
                                                 ...
                                                 <option value="Centimeter">Sarfaraz</option>
                                                 <option value="Millimeter">Ali</option>
                                                 <option value="Pixel">Imran</option>
                                                 </select></td>
                                                  <td>25-2-18</td>
                                                 ...
                                                 <option value="Inch">Khasdim Huassain</option>
                                                 <option value="Centimeter">Taha</option>
                                                 <option value="Millimeter">Ali</option>
                                                 <option value="Pixel">Imran</option>
                                                 </select></td>
                                                 ...
                                                 <option value="Inch">Arshad</option>
                                                 <option value="Centimeter">Taha</option>
                                                 <option value="Millimeter">Ali</option>
                                                 <option value="Pixel">Imran</option>
                                                 </select></td>
                                                 ...
                                                 <option value="Inch">Salman</option>
                                                 <option value="Centimeter">Taha</option>
                                                 <option value="Millimeter">Ali</option>
                                                 <option value="Pixel">Imran</option>
                                                 </select></td>
                                                 ...
                                                 <option value="Inch">Ahmed</option>
                                                 <option value="Centimeter">Taha</option>
                                                 <option value="Millimeter">Ali</option>
                                                 <option value="Pixel">Imran</option>
                                                 </select></td>
                                                  ...
                                                  <td>New Order</td>
                                                  <td><select class="form-control" name="Scale">
                                                 <option value="Inch">Umair</option>
                                                 <option value="Centimeter">Taha</option>
                                                 <option value="Millimeter">Ali</option>
                                                 <option value="Pixel">Imran</option>
                                                 </select></td>
                                                 ...
                                                 <option value="Inch">Bilal</option>
                                                 <option value="Centimeter">Taha</option>
                                                 <option value="Millimeter">Ali</option>
                                                 <option value="Pixel">Imran</option>
                                                 </select></td>
