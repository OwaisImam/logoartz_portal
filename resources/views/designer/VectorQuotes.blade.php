   ...
   <div class="row">
                                                ...
                                                @if(!empty($orders))
                                                    ...
                                                    <tr class="<?= $order->IsRead == 1 ? 'new' : '' ?>">
                                                       ...
                                                       <td>
                                                        ...
                                                        <?= $order->Status == 5 ? 
                                                        '<label class="label label-warning">Approved Order to Complete</label>' 
                                                        ...
                                                        : '<label class="label label-success">Quote Sent</label>'))) ?></td>
        ...
        <script language="javascript">
            ...
            $('#switch').change(function() {
                location.href='{{url("designer/vector")}}/'+$('#status').val();
              });
