                ...
                <div class="email-order-details" style="">
                    ...
                    <ul style="list-style-type: none; padding: 0; margin: 0;">
                        ...
                        @if ($FABRIC != null)
                            <li
                                style="padding: 5px 25px; background-color: #E7D098; width: 90%; margin: 0 auto; font-family: 'Roboto', sans-serif; font-weight: 600; color: #333; margin-bottom: 15px; border-radius: 8px;">
                                Fabric: <span style="font-weight: 600; color: #333;">{{ $FABRIC }}</span>
                            </li>
                        @endif
                        @if ($PLACEMENT != null)
                            <li
                                style="padding: 5px 25px; background-color: #E7D098; width: 90%; margin: 0 auto; font-family: 'Roboto', sans-serif; font-weight: 600; color: #333; margin-bottom: 15px; border-radius: 8px;">
                                Placement: <span style="font-weight: 600; color: #333;">{{ $PLACEMENT }}</span>
                            </li>
                        @endif
                        @if ($Width != null)
                            <li
                        ...
                        @if ($Fbrclr != null)
                            <li
                                style="padding: 5px 25px; background-color: #E7D098; width: 90%; margin: 0 auto; font-family: 'Roboto', sans-serif; font-weight: 600; color: #333; margin-bottom: 15px; border-radius: 8px;">
                                Fabric Color: <span style="font-weight: 600; color: #333;">{{ $Fbrclr }}</span>
                            </li>
                        @endif
