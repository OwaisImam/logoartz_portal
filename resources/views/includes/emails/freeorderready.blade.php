...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>  designName
        <div class="container">
            ...
            <p class="blue-text">Your {{ $designName }} free sample of {{ $OrderType }} is ready.</p>

            <p class="blue-text">
                Kindly check the files and please give us a feedback.<br>If you need any of our assistance, please feel free to let us know.
            </p>
