...
<head>
        ...
        <!-- Basic Page Needs
      ================================================== -->
        <title>{{ $configuration->WebsiteTitle }} | Vectar Quote</title>
            ...
            <div class="row">
                <div class="col-sm-12 text-center breadcrumb-block">
                    ...
                    if (\Session::has('CustomerLogin')) {
                        ...
                        <li class="active">Vector Quote</li>
...
<?php  } ?>
    ...
    <!--Services-->
            ...
            <div class="container" style="padding:2em;">
                <section>	
                     <h3 style="color:#555555;text-align: center;margin-top: 7px;">PLACE VECTOR QUOTE</h3>
        

                                 {{ Form::open(['method'=>'post', 'url'=>'/sbt_vector_quote', 'files'=>'true', 'novalidate'=>'novalidate']) }}
