...
function message_box(modal_label, modal_content, type, ok_callback, cancel_callback) {
	...
	if (type == "confirm") {
		$("#MessageModal .modal-footer").html('<button type="button" id="btnOK" data-dismiss="modal" class="btn btn-success"><i class="fa fa-check"></i> OK</button><button type="button" class="btn btn-warning" data-dismiss="modal"><i class="fa fa-times"></i> Cancel</button>');
	} else {
		$("#MessageModal .modal-footer").html('<button type="button" data-dismiss="modal" class="btn btn-success"><i class="fa fa-check"></i> OK</button>');
	}
	$("#MessageModal").modal();
	$("#btnOK").click(ok_callback);
}
